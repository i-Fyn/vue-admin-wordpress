  ...
  class CSF_Field_code_editor extends CSF_Fields {
    ...
    public function enqueue() {
      ...
      if ( ! wp_script_is( 'csf-codemirror' ) ) {
        ...
        wp_enqueue_script( 'csf-codemirror', IS_THEME_URI.'/Library/codestar-framework/assets/js/codemirror.min.js', array( 'csf' ), $this->version, true );
        wp_enqueue_script( 'csf-codemirror-loadmode', IS_THEME_URI.'/Library/codestar-framework/assets/js/loadmode.min.js' , array( 'csf-codemirror' ), $this->version, true );
      }
      ...
      if ( ! wp_style_is( 'csf-codemirror' ) ) {
        ...
        wp_enqueue_style( 'csf-codemirror', IS_THEME_URI.'/Library/codestar-framework/assets/css/codemirror.min.css', array(), $this->version );
      }
